   ...
   $.fn.validation.defaults = {
        validRules : [
            ...
            {name: 'date',validate:function(value){
            	/*ivan 2014-3-30 增加判断不为空时校验*/
            	if(value!=null&&value!=""){
            		return(/Invalid|NaN/.test(new Date(value).toString()));
            	}
            	},defaultMsg:"日期格式XXXX-XX-XX。"},
            /*ivan add 2014-3-30*/ 
            {name: 'start-end-date',validate:function(value){
    ...
    var validationForm = function(obj) {
        ...
        /*	ivan add 2014-3-30
        	当input的type为date（自定义的）类型时，触发on change事件后开始校验*/
...
/*		ivan 2014-3-30 添加注释，使用自定义"*"，提示用户
        //3.设置必填的标志*号
